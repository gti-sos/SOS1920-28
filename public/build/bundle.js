...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "API de PPA";
    			t1 = space();
    			button1 = element("button");
    			button1.textContent = "API de GCE";
    			t3 = space();
    			button2 = element("button");
    			button2.textContent = "API de EC";
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "btn btn-outline-success svelte-c63fqx");
    			attr_dev(button0, "onclick", "window.location.href='#/ppaAPI'");
    			add_location(button0, file, 3, 2, 63);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-outline-success svelte-c63fqx");
    			attr_dev(button1, "onclick", "window.location.href='#/gceAPI'");
    			add_location(button1, file, 4, 2, 186);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-outline-success svelte-c63fqx");
    			attr_dev(button2, "onclick", "window.location.href='#*'");
    			add_location(button2, file, 5, 2, 309);
    ...
    /* src\front\ppaAPI\PPATable.svelte generated by Svelte v3.20.1 */

    const { console: console_1$2 } = globals;
    const file$9 = "src\\front\\ppaAPI\\PPATable.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	button0.$on("click", /*ReloadTable*/ ctx[8]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*ppas, newPPA*/ 129 | dirty[1] & /*$$scope*/ 128) {
    ...
    // (285:1) <Button outline  color="primary" on:click="{ReloadTable}">
    function create_default_slot_21(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			t = text(" Recargar datos originales");
    			attr_dev(i, "class", "fas fa-search");
    			add_location(i, file$9, 284, 60, 6801);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(285:1) <Button outline  color=\\\"primary\\\" on:click=\\\"{ReloadTable}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_20(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(287:3) <Label for=\\\"selectCountry\\\">",
    		ctx
    	});
    ...
    // (289:4) {#each countries as country}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$9, 289, 4, 7072);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(289:4) {#each countries as country}",
    		ctx
    	});
    ...
    // (288:3) <Input type="select" name="selectCountry" id="selectCountry" bind:value="{currentCountry}">
    function create_default_slot_19(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "-";
    			option.value = option.__value;
    			add_location(option, file$9, 291, 4, 7115);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(288:3) <Input type=\\\"select\\\" name=\\\"selectCountry\\\" id=\\\"selectCountry\\\" bind:value=\\\"{currentCountry}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_17(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(297:3) <Label for=\\\"selectYear\\\">",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$9, 299, 4, 7338);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(299:4) {#each years as year}",
    		ctx
    	});
    ...
    // (298:3) <Input type="select"  name="selectYear" id="selectYear" bind:value="{currentYear}">
    function create_default_slot_16(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "-";
    			option.value = option.__value;
    			add_location(option, file$9, 301, 4, 7378);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(target, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(298:3) <Input type=\\\"select\\\"  name=\\\"selectYear\\\" id=\\\"selectYear\\\" bind:value=\\\"{currentYear}\\\">",
    		ctx
    	});
    ...
    // (306:2) <Button outline color="secondary" on:click="{search(currentCountry, currentYear)}" class="button-search" >
    function create_default_slot_14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(" Buscar");
    			attr_dev(i, "class", "fas fa-search");
    			add_location(i, file$9, 305, 109, 7534);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(306:2) <Button outline color=\\\"secondary\\\" on:click=\\\"{search(currentCountry, currentYear)}\\\" class=\\\"button-search\\\" >",
    		ctx
    	});
    ...
    // (328:10) <Button outline  color="primary" on:click={insertPpa} >
    function create_default_slot_13(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(328:10) <Button outline  color=\\\"primary\\\" on:click={insertPpa} >",
    		ctx
    	});
    ...
    // (339:10) <Button outline color="danger" on:click="{deletePPA(ppa.country,ppa.year)}">
    function create_default_slot_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$9, 338, 88, 8783);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(339:10) <Button outline color=\\\"danger\\\" on:click=\\\"{deletePPA(ppa.country,ppa.year)}\\\">",
    		ctx
    	});
    ...
    // (330:4) {#each ppas as ppa}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let a;
    	let t0_value = /*ppa*/ ctx[29].country + "";
    	let t0;
    	let a_href_value;
    	let t1;
    	let td1;
    	let t2_value = /*ppa*/ ctx[29].year + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*ppa*/ ctx[29].aas_gross + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*ppa*/ ctx[29].aas_net + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*ppa*/ ctx[29].ppa_per_capita + "";
    	let t8;
    	let t9;
    	let td5;
    	let t10;
    	...
    	button.$on("click", function () {
    		if (is_function(/*deletePPA*/ ctx[10](/*ppa*/ ctx[29].country, /*ppa*/ ctx[29].year))) /*deletePPA*/ ctx[10](/*ppa*/ ctx[29].country, /*ppa*/ ctx[29].year).apply(this, arguments);
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			attr_dev(a, "href", a_href_value = "#/ppas/" + /*ppa*/ ctx[29].country + "/" + /*ppa*/ ctx[29].year);
    			add_location(a, file$9, 332, 7, 8501);
    			add_location(td0, file$9, 331, 6, 8489);
    			add_location(td1, file$9, 334, 6, 8579);
    			add_location(td2, file$9, 335, 6, 8605);
    			add_location(td3, file$9, 336, 6, 8636);
    			add_location(td4, file$9, 337, 6, 8665);
    			add_location(td5, file$9, 338, 6, 8701);
    			add_location(tr, file$9, 330, 5, 8478);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*ppas*/ 128) && t0_value !== (t0_value = /*ppa*/ ctx[29].country + "")) set_data_dev(t0, t0_value);

    			if (!current || dirty[0] & /*ppas*/ 128 && a_href_value !== (a_href_value = "#/ppas/" + /*ppa*/ ctx[29].country + "/" + /*ppa*/ ctx[29].year)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty[0] & /*ppas*/ 128) && t2_value !== (t2_value = /*ppa*/ ctx[29].year + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty[0] & /*ppas*/ 128) && t4_value !== (t4_value = /*ppa*/ ctx[29].aas_gross + "")) set_data_dev(t4, t4_value);
    			if ((!current || dirty[0] & /*ppas*/ 128) && t6_value !== (t6_value = /*ppa*/ ctx[29].aas_net + "")) set_data_dev(t6, t6_value);
    			if ((!current || dirty[0] & /*ppas*/ 128) && t8_value !== (t8_value = /*ppa*/ ctx[29].ppa_per_capita + "")) set_data_dev(t8, t8_value);
    ...
    function create_default_slot_11(ctx) {
    	...
    	button.$on("click", /*insertPpa*/ ctx[9]);
    	let each_value = /*ppas*/ ctx[7];
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Salario Bruto";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "Salario neto";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Paridad de poder Adquisitivo";
    			t9 = space();
    			th5 = element("th");
    			...
    			add_location(th0, file$9, 311, 5, 7629);
    			add_location(th1, file$9, 312, 20, 7663);
    			add_location(th2, file$9, 313, 20, 7696);
    			add_location(th3, file$9, 314, 20, 7739);
    			add_location(th4, file$9, 315, 20, 7781);
    			add_location(th5, file$9, 316, 20, 7839);
    			add_location(tr0, file$9, 310, 4, 7619);
    			add_location(thead, file$9, 309, 3, 7607);
    			attr_dev(input0, "placeholder", "Ej. Spain");
    			add_location(input0, file$9, 322, 9, 7909);
    			add_location(td0, file$9, 322, 5, 7905);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Ej. 2000");
    			add_location(input1, file$9, 323, 9, 7986);
    			add_location(td1, file$9, 323, 5, 7982);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "placeholder", "Ej. 1111111");
    			add_location(input2, file$9, 324, 9, 8073);
    			add_location(td2, file$9, 324, 5, 8069);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "placeholder", "Ej. 1111111");
    			add_location(input3, file$9, 325, 9, 8167);
    			add_location(td3, file$9, 325, 5, 8163);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "placeholder", "Ej. 1111111");
    			add_location(input4, file$9, 326, 9, 8259);
    			add_location(td4, file$9, 326, 5, 8255);
    			add_location(td5, file$9, 327, 5, 8354);
    			add_location(tr1, file$9, 321, 4, 7895);
    			add_location(tbody, file$9, 320, 3, 7883);
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			set_input_value(input0, /*newPPA*/ ctx[0].country);
    			append_dev(tr1, t12);
    			append_dev(tr1, td1);
    			append_dev(td1, input1);
    			set_input_value(input1, /*newPPA*/ ctx[0].year);
    			append_dev(tr1, t13);
    			append_dev(tr1, td2);
    			append_dev(td2, input2);
    			set_input_value(input2, /*newPPA*/ ctx[0].aas_gross);
    			append_dev(tr1, t14);
    			append_dev(tr1, td3);
    			append_dev(td3, input3);
    			set_input_value(input3, /*newPPA*/ ctx[0].aas_net);
    			append_dev(tr1, t15);
    			append_dev(tr1, td4);
    			append_dev(td4, input4);
    			set_input_value(input4, /*newPPA*/ ctx[0].ppa_per_capita);
    			append_dev(tr1, t16);
    			append_dev(tr1, td5);
    			mount_component(button, td5, null);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*newPPA*/ 1 && input0.value !== /*newPPA*/ ctx[0].country) {
    				set_input_value(input0, /*newPPA*/ ctx[0].country);
    			}

    			if (!input1_updating && dirty[0] & /*newPPA*/ 1) {
    				set_input_value(input1, /*newPPA*/ ctx[0].year);
    			}

    			input1_updating = false;

    			if (!input2_updating && dirty[0] & /*newPPA*/ 1) {
    				set_input_value(input2, /*newPPA*/ ctx[0].aas_gross);
    			}

    			input2_updating = false;

    			if (!input3_updating && dirty[0] & /*newPPA*/ 1) {
    				set_input_value(input3, /*newPPA*/ ctx[0].aas_net);
    			}

    			input3_updating = false;

    			if (!input4_updating && dirty[0] & /*newPPA*/ 1) {
    				set_input_value(input4, /*newPPA*/ ctx[0].ppa_per_capita);
    			}
    			...
    			if (dirty[0] & /*deletePPA, ppas*/ 1152) {
    				each_value = /*ppas*/ ctx[7];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(282:14)    Loading ppas...  {:then ppas}",
    		ctx
    	});
    ...
    function create_default_slot_10(ctx) {
    	...
    	const paginationlink = new PaginationLink({
    			props: { previous: true, href: "#/ppaAPI" },
    			$$inline: true
    		});
    ...
    // (355:3) <PaginationLink href="#/ppaAPI" on:click="{() => addOffset(-1)}" >
    function create_default_slot_9(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(355:3) <PaginationLink href=\\\"#/ppaAPI\\\" on:click=\\\"{() => addOffset(-1)}\\\" >",
    		ctx
    	});
    ...
    // (359:3) <PaginationLink href="#/ppaAPI" >
    function create_default_slot_7(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(359:3) <PaginationLink href=\\\"#/ppaAPI\\\" >",
    		ctx
    	});
    ...
    // (363:3) <PaginationLink href="#/ppaAPI" on:click="{() => addOffset(1)}">
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(363:3) <PaginationLink href=\\\"#/ppaAPI\\\" on:click=\\\"{() => addOffset(1)}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$9, 372, 54, 9824);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    ...
    // (374:1) <Button outline  on:click={deletePPAcountries}   color="danger">
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "fa fa-trash");
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file$9, 373, 66, 9947);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(374:1) <Button outline  on:click={deletePPAcountries}   color=\\\"danger\\\">",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	handle_promise(promise = /*ppas*/ ctx[7], info);
    	...
    	button1.$on("click", /*deletePPAcountries*/ ctx[11]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 279, 1, 6629);
    			add_location(main, file$9, 278, 0, 6621);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*ppas*/ 128 && promise !== (promise = /*ppas*/ ctx[7]) && handle_promise(promise, info)) ; else {
    				const child_ctx = ctx.slice();
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	async function insertPpa() {
    		...
    		if (newPPA.country == "" || newPPA.country == null || newPPA.year == "" || newPPA.year == null) {
    	...
    	async function deletePPA(country, year) {
    		...
    		const res = await fetch("/api/v1/ppas/" + country + "/" + year, { method: "DELETE" }).then(function (res) {
    			if (res.ok) {
    				getPpa();
    				getCountryYears();
    	...
    	async function deletePPAcountries() {
    		...
    		const res = await fetch("/api/v1/ppas/", { method: "DELETE" }).then(function (res) {
    			if (res.ok) {
    				const json = res.json();
    				$$invalidate(7, ppas = json);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<PPATable> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("PPATable", $$slots, []);
    	...
    	function input0_input_handler() {
    		newPPA.country = this.value;
    		$$invalidate(0, newPPA);
    	}

    	function input1_input_handler() {
    		newPPA.year = to_number(this.value);
    		$$invalidate(0, newPPA);
    	}

    	function input2_input_handler() {
    		newPPA.aas_gross = to_number(this.value);
    		$$invalidate(0, newPPA);
    	}

    	function input3_input_handler() {
    		newPPA.aas_net = to_number(this.value);
    		$$invalidate(0, newPPA);
    	}

    	function input4_input_handler() {
    		newPPA.ppa_per_capita = to_number(this.value);
    		$$invalidate(0, newPPA);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("ppas" in $$props) $$invalidate(7, ppas = $$props.ppas);
    		if ("newPPA" in $$props) $$invalidate(0, newPPA = $$props.newPPA);
    ...
    class PPATable extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\front\ppaAPI\App.svelte generated by Svelte v3.20.1 */
    const file$a = "src\\front\\ppaAPI\\App.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	let t1;
    	let current;
    	const ppatable = new PPATable({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Administrador de datos de PPA";
    			t1 = space();
    			create_component(ppatable.$$.fragment);
    			attr_dev(h1, "class", "display-4");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$a, 5, 1, 71);
    			add_location(main, file$a, 4, 0, 63);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			mount_component(ppatable, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(ppatable.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(ppatable.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(ppatable);
    		}
    	};
    ...
    /* src\front\gceAPI\GCETable.svelte generated by Svelte v3.20.1 */

    const { console: console_1$3 } = globals;
    const file$b = "src\\front\\gceAPI\\GCETable.svelte";
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*gce, newGCE*/ 129 | dirty[1] & /*$$scope*/ 64) {
    				table_changes.$$scope = { dirty, ctx };
    			}
    ...
    // (284:1) <Button outline  color="primary" on:click="{ReloadTable}">
    function create_default_slot_21$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(" Recargar datos originales");
    			attr_dev(i, "class", "fas fa-search");
    			add_location(i, file$b, 283, 60, 6736);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(284:1) <Button outline  color=\\\"primary\\\" on:click=\\\"{ReloadTable}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_20$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(286:3) <Label for=\\\"selectCountry\\\">",
    		ctx
    	});
    ...
    // (288:4) {#each countries as country}
    function create_each_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$b, 288, 4, 7007);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(288:4) {#each countries as country}",
    		ctx
    	});
    ...
    // (287:3) <Input type="select" name="selectCountry" id="selectCountry" bind:value="{currentCountry}">
    function create_default_slot_19$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "-";
    			option.value = option.__value;
    			add_location(option, file$b, 290, 4, 7050);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(target, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(287:3) <Input type=\\\"select\\\" name=\\\"selectCountry\\\" id=\\\"selectCountry\\\" bind:value=\\\"{currentCountry}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_17$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(296:3) <Label for=\\\"selectYear\\\">",
    		ctx
    	});
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$b, 298, 4, 7273);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(298:4) {#each years as year}",
    		ctx
    	});
    ...
    // (297:3) <Input type="select"  name="selectYear" id="selectYear" bind:value="{currentYear}">
    function create_default_slot_16$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "-";
    			option.value = option.__value;
    			add_location(option, file$b, 300, 4, 7313);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(target, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(297:3) <Input type=\\\"select\\\"  name=\\\"selectYear\\\" id=\\\"selectYear\\\" bind:value=\\\"{currentYear}\\\">",
    		ctx
    	});
    ...
    // (305:2) <Button outline color="secondary" on:click="{search(currentCountry, currentYear)}" class="button-search" >
    function create_default_slot_14$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(" Buscar");
    			attr_dev(i, "class", "fas fa-search");
    			add_location(i, file$b, 304, 109, 7469);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(305:2) <Button outline color=\\\"secondary\\\" on:click=\\\"{search(currentCountry, currentYear)}\\\" class=\\\"button-search\\\" >",
    		ctx
    	});
    ...
    // (327:10) <Button outline  color="primary" on:click={insertGce} >
    function create_default_slot_13$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(327:10) <Button outline  color=\\\"primary\\\" on:click={insertGce} >",
    		ctx
    	});
    ...
    // (338:10) <Button outline color="danger" on:click="{deleteGCE(gce.country,gce.year)}">
    function create_default_slot_12$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "fa fa-trash");
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file$b, 337, 88, 8662);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(338:10) <Button outline color=\\\"danger\\\" on:click=\\\"{deleteGCE(gce.country,gce.year)}\\\">",
    		ctx
    	});
    ...
    // (329:4) {#each gce as gce}
    function create_each_block$1(ctx) {
    	let tr;
    	let td0;
    	let a;
    	let t0_value = /*gce*/ ctx[7].country + "";
    	let t0;
    	let a_href_value;
    	let t1;
    	let td1;
    	let t2_value = /*gce*/ ctx[7].year + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*gce*/ ctx[7].gce_country + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*gce*/ ctx[7].gce_per_capita + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*gce*/ ctx[7].gce_cars + "";
    	let t8;
    	let t9;
    	let td5;
    	let t10;
    	...
    	button.$on("click", function () {
    		if (is_function(/*deleteGCE*/ ctx[10](/*gce*/ ctx[7].country, /*gce*/ ctx[7].year))) /*deleteGCE*/ ctx[10](/*gce*/ ctx[7].country, /*gce*/ ctx[7].year).apply(this, arguments);
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button.$$.fragment);
    			t10 = space();
    			attr_dev(a, "href", a_href_value = "#/gce/" + /*gce*/ ctx[7].country + "/" + /*gce*/ ctx[7].year);
    			add_location(a, file$b, 331, 7, 8378);
    			add_location(td0, file$b, 330, 6, 8366);
    			add_location(td1, file$b, 333, 6, 8455);
    			add_location(td2, file$b, 334, 6, 8481);
    			add_location(td3, file$b, 335, 6, 8514);
    			add_location(td4, file$b, 336, 6, 8550);
    			add_location(td5, file$b, 337, 6, 8580);
    			add_location(tr, file$b, 329, 5, 8355);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*gce*/ 128) && t0_value !== (t0_value = /*gce*/ ctx[7].country + "")) set_data_dev(t0, t0_value);

    			if (!current || dirty[0] & /*gce*/ 128 && a_href_value !== (a_href_value = "#/gce/" + /*gce*/ ctx[7].country + "/" + /*gce*/ ctx[7].year)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty[0] & /*gce*/ 128) && t2_value !== (t2_value = /*gce*/ ctx[7].year + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty[0] & /*gce*/ 128) && t4_value !== (t4_value = /*gce*/ ctx[7].gce_country + "")) set_data_dev(t4, t4_value);
    			if ((!current || dirty[0] & /*gce*/ 128) && t6_value !== (t6_value = /*gce*/ ctx[7].gce_per_capita + "")) set_data_dev(t6, t6_value);
    			if ((!current || dirty[0] & /*gce*/ 128) && t8_value !== (t8_value = /*gce*/ ctx[7].gce_cars + "")) set_data_dev(t8, t8_value);
    			const button_changes = {};
    ...
    function create_default_slot_11$1(ctx) {
    	...
    	button.$on("click", /*insertGce*/ ctx[9]);
    	let each_value = /*gce*/ ctx[7];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Media Países por producción";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "Media per Capita";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Media de produccion de coches";
    			t9 = space();
    			th5 = element("th");
    			th5.textContent = "Acciones";
    			t11 = space();
    			...
    			add_location(th0, file$b, 310, 5, 7564);
    			add_location(th1, file$b, 311, 5, 7583);
    			add_location(th2, file$b, 312, 5, 7601);
    			add_location(th3, file$b, 313, 5, 7643);
    			add_location(th4, file$b, 314, 5, 7674);
    			add_location(th5, file$b, 315, 5, 7718);
    			add_location(tr0, file$b, 309, 4, 7554);
    			add_location(thead, file$b, 308, 3, 7542);
    			attr_dev(input0, "placeholder", "Ej. Spain");
    			add_location(input0, file$b, 321, 9, 7788);
    			add_location(td0, file$b, 321, 5, 7784);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Ej. 2000");
    			add_location(input1, file$b, 322, 9, 7865);
    			add_location(td1, file$b, 322, 5, 7861);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "placeholder", "Ej. 111111");
    			add_location(input2, file$b, 323, 9, 7952);
    			add_location(td2, file$b, 323, 5, 7948);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "placeholder", "Ej. 11,11");
    			add_location(input3, file$b, 324, 9, 8047);
    			add_location(td3, file$b, 324, 5, 8043);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "placeholder", "Ej. 111111");
    			add_location(input4, file$b, 325, 9, 8144);
    			add_location(td4, file$b, 325, 5, 8140);
    			add_location(td5, file$b, 326, 5, 8232);
    			add_location(tr1, file$b, 320, 4, 7774);
    			add_location(tbody, file$b, 319, 3, 7762);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, thead, anchor);
    			append_dev(thead, tr0);
    			...
    			append_dev(tr1, td0);
    			append_dev(td0, input0);
    			set_input_value(input0, /*newGCE*/ ctx[0].country);
    			append_dev(tr1, t12);
    			append_dev(tr1, td1);
    			append_dev(td1, input1);
    			set_input_value(input1, /*newGCE*/ ctx[0].year);
    			append_dev(tr1, t13);
    			append_dev(tr1, td2);
    			append_dev(td2, input2);
    			set_input_value(input2, /*newGCE*/ ctx[0].gce_country);
    			append_dev(tr1, t14);
    			append_dev(tr1, td3);
    			append_dev(td3, input3);
    			set_input_value(input3, /*newGCE*/ ctx[0].gce_per_capita);
    			append_dev(tr1, t15);
    			append_dev(tr1, td4);
    			append_dev(td4, input4);
    			set_input_value(input4, /*newGCE*/ ctx[0].gce_cars);
    			append_dev(tr1, t16);
    			append_dev(tr1, td5);
    			mount_component(button, td5, null);
    			append_dev(tbody, t17);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*newGCE*/ 1 && input0.value !== /*newGCE*/ ctx[0].country) {
    				set_input_value(input0, /*newGCE*/ ctx[0].country);
    			}

    			if (!input1_updating && dirty[0] & /*newGCE*/ 1) {
    				set_input_value(input1, /*newGCE*/ ctx[0].year);
    			}

    			input1_updating = false;

    			if (!input2_updating && dirty[0] & /*newGCE*/ 1) {
    				set_input_value(input2, /*newGCE*/ ctx[0].gce_country);
    			}

    			input2_updating = false;

    			if (!input3_updating && dirty[0] & /*newGCE*/ 1) {
    				set_input_value(input3, /*newGCE*/ ctx[0].gce_per_capita);
    			}

    			input3_updating = false;

    			if (!input4_updating && dirty[0] & /*newGCE*/ 1) {
    				set_input_value(input4, /*newGCE*/ ctx[0].gce_cars);
    			}
    			...
    			if (dirty[0] & /*deleteGCE, gce*/ 1152) {
    				each_value = /*gce*/ ctx[7];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_pending_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(281:13)    Loading gce...  {:then gce}",
    		ctx
    	});
    ...
    function create_default_slot_10$1(ctx) {
    	...
    	const paginationlink = new PaginationLink({
    			props: { previous: true, href: "#/gceAPI" },
    			$$inline: true
    		});
    ...
    // (354:3) <PaginationLink href="#/gceAPI" on:click="{() => addOffset(-1)}" >
    function create_default_slot_9$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(354:3) <PaginationLink href=\\\"#/gceAPI\\\" on:click=\\\"{() => addOffset(-1)}\\\" >",
    		ctx
    	});
    ...
    // (358:3) <PaginationLink href="#/gceAPI" >
    function create_default_slot_7$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(358:3) <PaginationLink href=\\\"#/gceAPI\\\" >",
    		ctx
    	});
    ...
    // (363:3) <PaginationLink href="#/gceAPI" on:click="{() => addOffset(1)}">
    function create_default_slot_5$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(363:3) <PaginationLink href=\\\"#/gceAPI\\\" on:click=\\\"{() => addOffset(1)}\\\">",
    		ctx
    	});
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(" Atrás");
    			attr_dev(i, "class", "fas fa-arrow-circle-left");
    			add_location(i, file$b, 372, 54, 9704);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    ...
    // (374:1) <Button outline  on:click={deleteGCEcountries}   color="danger">
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "fa fa-trash");
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file$b, 373, 66, 9827);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(374:1) <Button outline  on:click={deleteGCEcountries}   color=\\\"danger\\\">",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	handle_promise(promise = /*gce*/ ctx[7], info);
    	...
    	button1.$on("click", /*deleteGCEcountries*/ ctx[11]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "div_alert");
    			set_style(div, "display", "none");
    			add_location(div, file$b, 278, 1, 6567);
    			add_location(main, file$b, 277, 0, 6559);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*gce*/ 128 && promise !== (promise = /*gce*/ ctx[7]) && handle_promise(promise, info)) ; else {
    				const child_ctx = ctx.slice();
    				child_ctx[7] = info.resolved;
    				info.block.p(child_ctx, dirty);
    			}
    ...
    function errorResponse$1(res, msg) {
    	var status = res.status;
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	async function ReloadTable() {
    		...
    		if (res.ok) {
    			...
    			getGCE();
    			responseAlert$1("Se ha reiniciado la tabla correctamente con los valores iniciales");
    		} else {
    			console.log("No se han cargado correctamente los datos iniciales");
    			errorResponse$1(res);
    		}
    	...
    	async function insertGce() {
    		...
    		if (newGCE.country == "" || newGCE.country == null || newGCE.year == "" || newGCE.year == null) {
    			alert("Se debe incluir el nombre del país y el año obligatoriamente");
    		} else {
    			const res = await fetch("/api/v1/gce", {
    				method: "POST",
    				...
    				if (res.ok) {
    					getGCE();
    					responseAlert$1("Datos de " + newGCE.country + " añadidos correctamente");
    				} else {
    					errorResponse$1(res);
    				}
    			});
    	...
    	async function deleteGCE(country, year) {
    		...
    		const res = await fetch("/api/v1/gce/" + country + "/" + year, { method: "DELETE" }).then(function (res) {
    			if (res.ok) {
    				getGCE();
    				getCountryYears();
    				responseAlert$1("El dato se ha borrado correctamente");
    			} else {
    				errorResponse$1(res);
    			}
    		});
    	...
    	async function deleteGCEcountries() {
    		...
    		const res = await fetch("/api/v1/gce/", { method: "DELETE" }).then(function (res) {
    			if (res.ok) {
    				const json = res.json();
    				$$invalidate(7, gce = json);
    				responseAlert$1("Todos los datos se han borrado correctamente");
    			} else {
    				errorResponse$1(res);
    			}
    		});
    	...
    	async function search(country, year) {
    		...
    		if (res.ok) {
    			...
    			if (country != "-" && year != "-") {
    				responseAlert$1("Busqueda de " + country + " en el año " + year + " realizada correctamente");
    			} else if (country != "-" && year == "-") {
    				responseAlert$1("Busqueda de " + country + " realizada correctamente");
    			} else if (country == "-" && year != "-") {
    				responseAlert$1("Busqueda en el año " + year + " realizada correctamente");
    			}
    		} else {
    			errorResponse$1(res);
    			console.log("ERROR!");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<GCETable> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("GCETable", $$slots, []);
    	...
    	function input0_input_handler() {
    		newGCE.country = this.value;
    		$$invalidate(0, newGCE);
    	}

    	function input1_input_handler() {
    		newGCE.year = to_number(this.value);
    		$$invalidate(0, newGCE);
    	}

    	function input2_input_handler() {
    		newGCE.gce_country = to_number(this.value);
    		$$invalidate(0, newGCE);
    	}

    	function input3_input_handler() {
    		newGCE.gce_per_capita = to_number(this.value);
    		$$invalidate(0, newGCE);
    	}

    	function input4_input_handler() {
    		newGCE.gce_cars = to_number(this.value);
    		$$invalidate(0, newGCE);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("gce" in $$props) $$invalidate(7, gce = $$props.gce);
    		if ("newGCE" in $$props) $$invalidate(0, newGCE = $$props.newGCE);
    		if ("countries" in $$props) $$invalidate(1, countries = $$props.countries);
    		if ("years" in $$props) $$invalidate(2, years = $$props.years);
    		if ("currentCountry" in $$props) $$invalidate(3, currentCountry = $$props.currentCountry);
    		if ("currentYear" in $$props) $$invalidate(4, currentYear = $$props.currentYear);
    ...
    class GCETable extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\front\gceAPI\App.svelte generated by Svelte v3.20.1 */
    const file$c = "src\\front\\gceAPI\\App.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	let t1;
    	let current;
    	const gcetable = new GCETable({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Administrador de datos de GCE";
    			t1 = space();
    			create_component(gcetable.$$.fragment);
    			attr_dev(h1, "class", "display-4");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$c, 5, 1, 71);
    			add_location(main, file$c, 4, 0, 63);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			mount_component(gcetable, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(gcetable.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(gcetable.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(gcetable);
    		}
    	};
    ...
    /* src\front\ppaAPI\EditPpa.svelte generated by Svelte v3.20.1 */

    const { console: console_1$4 } = globals;
    const file$d = "src\\front\\ppaAPI\\EditPpa.svelte";
    ...
    function create_then_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, updatedPpa_per_capita, updatedAss_net, updatedAas_gross, updatedYear, updatedCountry*/ 8223) {
    				table_changes.$$scope = { dirty, ctx };
    			}
    ...
    // (156:25) <Button outline  color="primary" on:click={updatePPA}>
    function create_default_slot_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$d, 155, 110, 4730);
    			attr_dev(i1, "class", "fas fa-pencil-alt");
    			add_location(i1, file$d, 155, 80, 4700);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(156:25) <Button outline  color=\\\"primary\\\" on:click={updatePPA}>",
    		ctx
    	});
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	button.$on("click", /*updatePPA*/ ctx[7]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Media Salario Bruto";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "Media Salario neto";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Media Paridad de poder Adquisitivo";
    			t9 = space();
    			th5 = element("th");
    			th5.textContent = "Acciones";
    			t11 = space();
    			...
    			td5 = element("td");
    			create_component(button.$$.fragment);
    			add_location(th0, file$d, 140, 20, 3949);
    			add_location(th1, file$d, 141, 20, 3983);
    			add_location(th2, file$d, 142, 20, 4016);
    			add_location(th3, file$d, 143, 20, 4065);
    			add_location(th4, file$d, 144, 20, 4113);
    			add_location(th5, file$d, 145, 20, 4177);
    			add_location(tr0, file$d, 139, 16, 3924);
    			add_location(thead, file$d, 138, 12, 3900);
    			add_location(td0, file$d, 150, 20, 4299);
    			add_location(td1, file$d, 151, 20, 4345);
    			attr_dev(input0, "type", "number");
    			add_location(input0, file$d, 152, 24, 4392);
    			add_location(td2, file$d, 152, 20, 4388);
    			attr_dev(input1, "type", "number");
    			add_location(input1, file$d, 153, 24, 4475);
    			add_location(td3, file$d, 153, 20, 4471);
    			attr_dev(input2, "type", "number");
    			add_location(input2, file$d, 154, 24, 4556);
    			add_location(td4, file$d, 154, 20, 4552);
    			add_location(td5, file$d, 155, 20, 4640);
    			add_location(tr1, file$d, 149, 16, 4274);
    			add_location(tbody, file$d, 148, 12, 4250);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, thead, anchor);
    			append_dev(thead, tr0);
    			...
    			set_input_value(input0, /*updatedAas_gross*/ ctx[2]);
    			append_dev(tr1, t16);
    			append_dev(tr1, td3);
    			append_dev(td3, input1);
    			set_input_value(input1, /*updatedAss_net*/ ctx[3]);
    			append_dev(tr1, t17);
    			append_dev(tr1, td4);
    			append_dev(td4, input2);
    			set_input_value(input2, /*updatedPpa_per_capita*/ ctx[4]);
    			append_dev(tr1, t18);
    			append_dev(tr1, td5);
    			mount_component(button, td5, null);
    			current = true;
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!input0_updating && dirty & /*updatedAas_gross*/ 4) {
    				set_input_value(input0, /*updatedAas_gross*/ ctx[2]);
    			}

    			input0_updating = false;

    			if (!input1_updating && dirty & /*updatedAss_net*/ 8) {
    				set_input_value(input1, /*updatedAss_net*/ ctx[3]);
    			}

    			input1_updating = false;

    			if (!input2_updating && dirty & /*updatedPpa_per_capita*/ 16) {
    				set_input_value(input2, /*updatedPpa_per_capita*/ ctx[4]);
    			}
    ...
    function create_pending_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(135:16)          Loading ppa...     {:then ppa}",
    		ctx
    	});
    ...
    function create_if_block$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$d, 161, 8, 4887);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$e(ctx) {
    	...
    	let t1;
    	let strong;
    	let t2_value = /*ppa*/ ctx[6].country + "";
    	let t2;
    	let t3;
    	let t4_value = /*ppa*/ ctx[6].year + "";
    	let t4;
    	let t5;
    	let promise;
    	let t6;
    	...
    	handle_promise(promise = /*ppa*/ ctx[6], info);
    	let if_block = /*errorMsg*/ ctx[5] && create_if_block$8(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "div_alert");
    			set_style(div, "display", "none");
    			add_location(div, file$d, 131, 4, 3676);
    			add_location(strong, file$d, 133, 19, 3760);
    			add_location(h3, file$d, 133, 4, 3745);
    			add_location(main, file$d, 129, 0, 3664);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*ppa*/ 64) && t2_value !== (t2_value = /*ppa*/ ctx[6].country + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*ppa*/ 64) && t4_value !== (t4_value = /*ppa*/ ctx[6].year + "")) set_data_dev(t4, t4_value);
    			info.ctx = ctx;

    			if (dirty & /*ppa*/ 64 && promise !== (promise = /*ppa*/ ctx[6]) && handle_promise(promise, info)) ; else {
    				const child_ctx = ctx.slice();
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	async function getPpa() {
    		...
    		if (res.ok) {
    			console.log("Ok:");
    			const json = await res.json();
    			$$invalidate(6, ppa = json);
    			$$invalidate(0, updatedCountry = ppa.country);
    			$$invalidate(1, updatedYear = ppa.year);
    			$$invalidate(2, updatedAas_gross = ppa.aas_gross);
    			$$invalidate(3, updatedAss_net = ppa.aas_net);
    			$$invalidate(4, updatedPpa_per_capita = ppa.ppa_per_capita);
    	...
    	async function updatePPA() {
    		...
    		const res = await fetch("/api/v1/ppas/" + params.country + "/" + params.year, {
    			...
    			if (res.ok) {
    				responseAlert$2("Los datos de " + params.country + " en el año " + params.year + " han sido actualizados correctamente");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$4.warn(`<EditPpa> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("EditPpa", $$slots, []);

    	function input0_input_handler() {
    		updatedAas_gross = to_number(this.value);
    		$$invalidate(2, updatedAas_gross);
    	}

    	function input1_input_handler() {
    		updatedAss_net = to_number(this.value);
    		$$invalidate(3, updatedAss_net);
    	}

    	function input2_input_handler() {
    		updatedPpa_per_capita = to_number(this.value);
    		$$invalidate(4, updatedPpa_per_capita);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("params" in $$props) $$invalidate(8, params = $$props.params);
    		if ("ppa" in $$props) $$invalidate(6, ppa = $$props.ppa);
    		...
    		if ("updatedAas_gross" in $$props) $$invalidate(2, updatedAas_gross = $$props.updatedAas_gross);
    		if ("updatedAss_net" in $$props) $$invalidate(3, updatedAss_net = $$props.updatedAss_net);
    		if ("updatedPpa_per_capita" in $$props) $$invalidate(4, updatedPpa_per_capita = $$props.updatedPpa_per_capita);
    ...
    class EditPpa extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { params: 8 });
    	...
    	get params() {
    		throw new Error("<EditPpa>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error("<EditPpa>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src\front\gceAPI\EditGce.svelte generated by Svelte v3.20.1 */

    const { console: console_1$5 } = globals;
    const file$e = "src\\front\\gceAPI\\EditGce.svelte";
    ...
    function create_then_block$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, updatedGce_cars, updatedGce_per_capita, updatedGce_country, updatedYear, updatedCountry*/ 8223) {
    				table_changes.$$scope = { dirty, ctx };
    			}
    ...
    // (156:25) <Button outline  color="primary" on:click={updateGCE}>
    function create_default_slot_2$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(" Actualizar");
    			attr_dev(i0, "class", "fas fa-pencil-alt");
    			add_location(i0, file$e, 155, 110, 4673);
    			attr_dev(i1, "class", "fas fa-pencil-alt");
    			add_location(i1, file$e, 155, 80, 4643);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i1, anchor);
    			append_dev(i1, i0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(156:25) <Button outline  color=\\\"primary\\\" on:click={updateGCE}>",
    		ctx
    	});
    ...
    function create_default_slot_1$3(ctx) {
    	...
    	button.$on("click", /*updateGCE*/ ctx[7]);
    	...
    	const block = {
    		c: function create() {
    			...
    			td5 = element("td");
    			create_component(button.$$.fragment);
    			add_location(th0, file$e, 140, 20, 3963);
    			add_location(th1, file$e, 141, 5, 3982);
    			add_location(th2, file$e, 142, 5, 4000);
    			add_location(th3, file$e, 143, 5, 4042);
    			add_location(th4, file$e, 144, 5, 4073);
    			add_location(th5, file$e, 145, 5, 4117);
    			add_location(tr0, file$e, 139, 16, 3938);
    			add_location(thead, file$e, 138, 12, 3914);
    			add_location(td0, file$e, 150, 20, 4239);
    			add_location(td1, file$e, 151, 20, 4285);
    			attr_dev(input0, "type", "number");
    			add_location(input0, file$e, 152, 24, 4332);
    			add_location(td2, file$e, 152, 20, 4328);
    			attr_dev(input1, "type", "number");
    			add_location(input1, file$e, 153, 24, 4417);
    			add_location(td3, file$e, 153, 20, 4413);
    			attr_dev(input2, "type", "number");
    			add_location(input2, file$e, 154, 24, 4505);
    			add_location(td4, file$e, 154, 20, 4501);
    			add_location(td5, file$e, 155, 20, 4583);
    			add_location(tr1, file$e, 149, 16, 4214);
    			add_location(tbody, file$e, 148, 12, 4190);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, thead, anchor);
    			append_dev(thead, tr0);
    			...
    			append_dev(tr1, td2);
    			append_dev(td2, input0);
    			set_input_value(input0, /*updatedGce_country*/ ctx[2]);
    			append_dev(tr1, t16);
    			append_dev(tr1, td3);
    			append_dev(td3, input1);
    			set_input_value(input1, /*updatedGce_per_capita*/ ctx[3]);
    			append_dev(tr1, t17);
    			append_dev(tr1, td4);
    			append_dev(td4, input2);
    			set_input_value(input2, /*updatedGce_cars*/ ctx[4]);
    			append_dev(tr1, t18);
    			append_dev(tr1, td5);
    			mount_component(button, td5, null);
    			current = true;
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!input0_updating && dirty & /*updatedGce_country*/ 4) {
    				set_input_value(input0, /*updatedGce_country*/ ctx[2]);
    			}

    			input0_updating = false;

    			if (!input1_updating && dirty & /*updatedGce_per_capita*/ 8) {
    				set_input_value(input1, /*updatedGce_per_capita*/ ctx[3]);
    			}

    			input1_updating = false;

    			if (!input2_updating && dirty & /*updatedGce_cars*/ 16) {
    				set_input_value(input2, /*updatedGce_cars*/ ctx[4]);
    			}
    ...
    function create_pending_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(135:16)          Loading gce...     {:then gce}",
    		ctx
    	});
    ...
    function create_if_block$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(/*errorMsg*/ ctx[5]);
    			set_style(p, "color", "red");
    			add_location(p, file$e, 161, 8, 4830);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    function create_fragment$f(ctx) {
    	...
    	let t1;
    	let strong;
    	let t2_value = /*gce*/ ctx[6].country + "";
    	let t2;
    	let t3;
    	let t4_value = /*gce*/ ctx[6].year + "";
    	let t4;
    	let t5;
    	let promise;
    	let t6;
    	...
    	handle_promise(promise = /*gce*/ ctx[6], info);
    	let if_block = /*errorMsg*/ ctx[5] && create_if_block$9(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "div_alert");
    			set_style(div, "display", "none");
    			add_location(div, file$e, 131, 4, 3690);
    			add_location(strong, file$e, 133, 19, 3774);
    			add_location(h3, file$e, 133, 4, 3759);
    			add_location(main, file$e, 129, 0, 3678);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*gce*/ 64) && t2_value !== (t2_value = /*gce*/ ctx[6].country + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*gce*/ 64) && t4_value !== (t4_value = /*gce*/ ctx[6].year + "")) set_data_dev(t4, t4_value);
    			info.ctx = ctx;

    			if (dirty & /*gce*/ 64 && promise !== (promise = /*gce*/ ctx[6]) && handle_promise(promise, info)) ; else {
    				const child_ctx = ctx.slice();
    				child_ctx[6] = info.resolved;
    				info.block.p(child_ctx, dirty);
    			}
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	async function getGCE() {
    		...
    		if (res.ok) {
    			console.log("Ok:");
    			const json = await res.json();
    			$$invalidate(6, gce = json);
    			$$invalidate(0, updatedCountry = gce.country);
    			$$invalidate(1, updatedYear = gce.year);
    			$$invalidate(2, updatedGce_country = gce.gce_country);
    			$$invalidate(3, updatedGce_per_capita = gce.gce_per_capita);
    			$$invalidate(4, updatedGce_cars = gce.gce_cars);
    	...
    	async function updateGCE() {
    		...
    		const res = await fetch("/api/v1/gce/" + params.country + "/" + params.year, {
    			...
    			if (res.ok) {
    				responseAlert$3("Los datos de " + params.country + " en el año " + params.year + " han sido actualizados correctamente");
    			} else if (res.status == 404) {
    				errorAlert("Se ha intentado borrar un elemento inexistente.");
    			}
    		});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$5.warn(`<EditGce> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("EditGce", $$slots, []);

    	function input0_input_handler() {
    		updatedGce_country = to_number(this.value);
    		$$invalidate(2, updatedGce_country);
    	}

    	function input1_input_handler() {
    		updatedGce_per_capita = to_number(this.value);
    		$$invalidate(3, updatedGce_per_capita);
    	}

    	function input2_input_handler() {
    		updatedGce_cars = to_number(this.value);
    		$$invalidate(4, updatedGce_cars);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("params" in $$props) $$invalidate(8, params = $$props.params);
    		if ("gce" in $$props) $$invalidate(6, gce = $$props.gce);
    		if ("updatedCountry" in $$props) $$invalidate(0, updatedCountry = $$props.updatedCountry);
    		if ("updatedYear" in $$props) $$invalidate(1, updatedYear = $$props.updatedYear);
    		if ("updatedGce_country" in $$props) $$invalidate(2, updatedGce_country = $$props.updatedGce_country);
    		if ("updatedGce_per_capita" in $$props) $$invalidate(3, updatedGce_per_capita = $$props.updatedGce_per_capita);
    		if ("updatedGce_cars" in $$props) $$invalidate(4, updatedGce_cars = $$props.updatedGce_cars);
    		if ("errorMsg" in $$props) $$invalidate(5, errorMsg = $$props.errorMsg);
    	};
    ...
    class EditGce extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { params: 8 });
    	...
    	get params() {
    		throw new Error("<EditGce>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error("<EditGce>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "La pagina que estas buscando no existe, lo sentimos.";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$g, 23, 0, 475);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
